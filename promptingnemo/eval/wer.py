"""Multi-metric WER evaluation with entity (NER) scoring.

Extracted from scripts/asr/meta-asr/eval/multi_wer.py.
"""
...
from promptingnemo.eval.ner import get_ner_scores
...
def multi_word_error_rate(hypotheses: List[str], references: List[str], tags: dict, score_type: str, use_cer=False) -> Tuple[float, dict]:
    ...
    metrics = get_ner_scores(ref_label_list, hypo_label_list)
