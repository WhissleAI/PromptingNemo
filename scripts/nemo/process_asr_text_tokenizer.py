...
def read_user_defined_symbols(symbolsfile):

    with open(symbolsfile, 'r') as f:
        user_defined_symbols = f.readlines()
    user_defined_symbols = [x.strip() for x in user_defined_symbols] 
...
parser.add_argument('--user_defined_symbols_file', type=str, help='List of user defined symbols to add to tokenizer')
...
def main():
    ...
    user_defined_symbols_file = args.user_defined_symbols_file

    user_defined_symbols = read_user_defined_symbols(user_defined_symbols_file)
    print("USER DEFINED SYMBOLS: ", user_defined_symbols)
